            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    @endif
                    <form role="form" method="post" action="{{route('menus/add-menu')}}" enctype="multipart/form-data"> @csrf
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="city_tag" class="form-control" id="city_tag" placeholder="Enter city tag">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">City title *</label>
                            <input type="text" name="city_title" class="form-control" id="city_title" placeholder="Enter city title">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputFile">City img *</label>
                          <div class="input-group">
                            <div class="custom-file">
                              <input type="file" class="custom-file-input " name="city_img" id="city_img" multiple>
